...
function LoveLetter() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      q,
      (snapshot) => {
        const firestoreLetters = snapshot.docs.map((doc) => ({
    ...
    <div className="loveletter-gradient-bg">
      ...
      <div className="loveletter-container">
        ...
        {letterContent.map((letter, index) => (
          <div className="loveletter-box" key={index}>
            ...
            <div className="loveletter-timestamp">
